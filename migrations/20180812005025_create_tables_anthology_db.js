...
exports.up = function(knex, Promise) {
    ...
    function createAuthorsTable() {
      return knex.raw('CREATE TABLE authors (author_id integer GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, author_name TEXT NOT NULL, author_bio TEXT, author_photo TEXT, author_video_link TEXT, author_website_url TEXT)');
    }
